...
The problem set is published at the following:
...
```{r "2_c_2",fig.width=7, fig.height=7}
dataGDP <- datamacro %>%
...
Quiz: Which country in our data set has the lowest Economic Freedom Index of 29.4?
...
answer.quiz("Minimum value of the Economic Freedom Index")
```

<br>

Quiz: Which country in our data set has the highest Economic Freedom Index of 82.6?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Maximum value of the Economic Freedom Index")
```
...
```{r "4_a_3",fig.width=7, fig.height=7}
ggplot() +
...
```{r "4_a_5",fig.width=7, fig.height=7}
ggplot() +
...
```{r "4_b_2",fig.width=7, fig.height=7}
ggplot() +
...
```{r "5_3",fig.width=7, fig.height=7}
ggplot() +
...
Quiz: You know the average support for the East already, what do you think, which group from which period has the highest average support for a market economy?

[1]: Older group from the East
[2]: Older group from the West
[3]: Younger group from the East
[4]: Younger group from the West

```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Maximum average support for market economy")
```
<br>
**Task 2.2.7**
...
Quiz: In 2017, the minimum value of the index of democratization has been 8. How many countries in our data set (30 countries in total) did receive this score?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Minimum value of the Index of Democratization")
```
<br>
**Task 3.1.3**
...
```{r "9_3",fig.width=7, fig.height=7}
ggplot() +
...
```{r "10_3",fig.width=7, fig.height=7}
ggplot() +
...
Quiz: What was the share of pretax income that went to the top 10 percent in the West in 1990?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Income inequality in 1990")
```

<br>

Quiz: What was the share of pretax income that went to the top 10 percent in the East in 2006?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Income inequality in 2006")
```
...
```{r "12_4",fig.width=10, fig.height=7}
library(patchwork)
...
Quiz: Which cohort do you think has the highest support for redistribution, according to the Social Inequality module IV?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Highest support for redistribution")
```
...
```{r "13_3",fig.width=7, fig.height=7}
ggplot() +
...
Quiz: Which country has the highest percentage of women working in 1990?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Highest share of women participating in labor in 1990")
```
...
```{r "15_5",fig.width=10, fig.height=7}
...
```{r "16_3",fig.width=7, fig.height=7}
ggplot() +
...
Quiz: Do you think the average support for gender equality is higher in East Germany than in the EU East?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("Comparison between East Germany and the EU East")
```
...
```{r "16_5",fig.width=7, fig.height=7}
ggplot() +
